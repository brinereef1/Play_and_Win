...
using System.Linq;
public class JMLastTenHistoryManager : MonoBehaviour
{
    ...
    private string api_url = "http://13.234.117.221:2556/api/v1/user/last10jhandimunda";
        ...
        using (UnityWebRequest request = UnityWebRequest.Get(api_url))
        {
            ...
            if (request.result == UnityWebRequest.Result.Success)
            {
                ...
                foreach (var item in lastTen_winResponse.games)
                {
                    ...
                    var Script = win.transform.GetComponent<JMLastTenHistoryDisplay>();
...
[System.Serializable]
public class JMLastTenWinResponse
{
