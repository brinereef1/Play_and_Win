...
public class SuperRouletteTimer : MonoBehaviour
{
    ...
    SuperRouletteSelectedColorWithNumber superRouletteSelectedColorWithNumbers;
    ...
    void Start()
    {
        ...
        SuperRouletteWinningHistoryManager = FindFirstObjectByType<SuperRouletteWinningHistoryManager>();
        ...
        superRouletteSelectedColorWithNumbers = FindFirstObjectByType<SuperRouletteSelectedColorWithNumber>();
    }
    ...
    private IEnumerator GetCurrentTime()
    {
        ...
        string live_url = "http://13.234.117.221:2556/api/v1/user/lastgame_roulette";
        ...
        using (UnityWebRequest request = UnityWebRequest.Get(live_url))
        {
            ...
            if (request.result == UnityWebRequest.Result.Success)
            {
                ...
                if (minutes == 0 && seconds < 11)
                {
                    ...
                    if (rouletteBallController != null)
                    {
                        rouletteBallController.StartSpinTheBall();
                        rouletteBallController.StartSpinNumberPlate();
    ...
    {
        if (superRouletteSelectedColorWithNumbers != null)
        {
            superRouletteSelectedColorWithNumbers.GetChosenNumber();
        }
        ...
        if (rouletteBallController != null)
        {
            ...
            rouletteBallController.StopSpinTheBall();
        }
    }
