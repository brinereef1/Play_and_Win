...
public class RouletteWalletManager : MonoBehaviour
{
    ...
    private IEnumerator GetBalanceCoroutine()
    {
        ...
        using (UnityWebRequest request = UnityWebRequest.Get(getBalanceUrl))
        {
            ...
            if (request.result == UnityWebRequest.Result.Success)
            {
                ...
                RouletteWalletResponse response = JsonConvert.DeserializeObject<RouletteWalletResponse>(jsonResponse);
...
[System.Serializable]
public class RouletteWalletResponse
{
