...
public class ThunderBallWalletManager : MonoBehaviour
{
    ...
    private IEnumerator GetBalanceCoroutine()
    {
        ...
        using (UnityWebRequest request = UnityWebRequest.Get(getBalanceUrl))
        {
            ...
            if (request.result == UnityWebRequest.Result.Success)
            {
                ...
                ThunderBallWalletResponse response = JsonConvert.DeserializeObject<ThunderBallWalletResponse>(jsonResponse);
...
[System.Serializable]
public class ThunderBallWalletResponse
{
