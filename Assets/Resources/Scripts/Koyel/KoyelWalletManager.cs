...
public class KoyelWalletManager : MonoBehaviour
{
    ...
    private IEnumerator GetBalanceCoroutine()
    {
        ...
        using (UnityWebRequest request = UnityWebRequest.Get(getBalanceUrl))
        {
            ...
            if (request.result == UnityWebRequest.Result.Success)
            {
                ...
                KoyelResponse response = JsonConvert.DeserializeObject<KoyelResponse>(jsonResponse);
