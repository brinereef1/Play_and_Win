...
public class LuckyLottoLastTenWinHistoryManager : MonoBehaviour
{
    ...
    private string api_url = "http://13.234.117.221:2556/api/v1/user/last10luckyloto";
        ...
        using (UnityWebRequest request = UnityWebRequest.Get(api_url))
        {
            ...
            if (request.result == UnityWebRequest.Result.Success)
            {
                ...
                foreach (var item in lastTen_winResponse.games)
                {
                    ...
                    var Script = win.transform.GetComponent<LuckyLottoLastTenWinDisplay>();
...
[System.Serializable]
public class LLLastTenWinResponse
{
