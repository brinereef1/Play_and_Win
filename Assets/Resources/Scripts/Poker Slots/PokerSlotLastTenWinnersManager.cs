...
using System.Linq;
public class PokerSlotLastTenWinnersManager : MonoBehaviour
{
    ...
    private string api_url = "http://13.234.117.221:2556/api/v1/user/last10poker";
    ...
    IEnumerator LastTenWinHistoryRequest()
    {
        ...
        using (UnityWebRequest request = UnityWebRequest.Get(api_url))
        {
            ...
            PSLastTenWinResponse lastTen_winResponse = JsonConvert.DeserializeObject<PSLastTenWinResponse>(response);
            if (request.result == UnityWebRequest.Result.Success)
            {
                ...
                foreach (var item in lastTen_winResponse.games)
                {
                    ...
                    var Script = win.transform.GetComponent<PokerSlotLastTenWinDisplay>();
...
[System.Serializable]
public class PSLastTenWinResponse
{
