...
public class PokerSlotWinHistoryManager : MonoBehaviour
{
    ...
    private string win_history_api_url = "http://13.234.117.221:2556/api/v1/user/userwinhistory_poker2";
    ...
    void Start()
    {
        ...
        // winHistoryPanelView.gameObject.SetActive(false);
    ...
    IEnumerator WinHistoryRequest()
    {
        ...
        using (UnityWebRequest request = UnityWebRequest.Get(win_history_api_url))
        {
            ...
            PokerSlotWinResponse winResponse = JsonConvert.DeserializeObject<PokerSlotWinResponse>(response);
            if (request.result == UnityWebRequest.Result.Success)
            {
                ...
                foreach (var item in winResponse.data)
                {
                    ...
                    var Script = win.transform.GetComponent<PokerSlotWinHistoryDisplay>();
...
[System.Serializable]
public class PokerSlotWinResponse
{
    public bool success { get; set; }
    public List<PokerSlotDatum> data { get; set; }
}
