...
public class PokerSlotsTimer : MonoBehaviour
{
    ...
    SpinnerWheel sw = new SpinnerWheel();

    [Header("Bet Not Available Panel")]
    ...
    PokerSlotWinHistoryManager pokerslotWinHistoryManager; 
    ...
    void Start()
    {
        ...
        sw = FindFirstObjectByType<SpinnerWheel>();
        ...
        pokerslotWinHistoryManager = FindFirstObjectByType<PokerSlotWinHistoryManager>();
    ...
    private IEnumerator GetCurrentTime()
    {
        ...
        string live_url = "http://13.234.117.221:2556/api/v1/user/lastgame_poker";
        ...
        using (UnityWebRequest request = UnityWebRequest.Get(live_url))
        {
            ...
            if (request.result == UnityWebRequest.Result.Success)
            {
                ...
                PSDataForTime psDataForTime = JsonUtility.FromJson<PSDataForTime>(jsonResponse);
                ...
                if (current_gameId != tempStoredGame_Id)
                {
                    ...
                    if (pokerslotWinHistoryManager != null)
                    {
                        pokerslotWinHistoryManager.WinHistoryButtonClick();
                    }
                    else
                    {
                        Debug.Log("WinHistory Manager is Null.");
                    }
                    ...
                    {
                        Debug.LogError("SpinnerWheel script not found.");
                    }
