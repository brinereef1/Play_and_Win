...
public class PattiTimer : MonoBehaviour
{
    ...
    PattiWinHistoryManager pattiWinHistoryManager;
    ...
    void Start()
    {
        ...
        pattiWinHistoryManager = FindFirstObjectByType<PattiWinHistoryManager>();
    ...
    private IEnumerator GetCurrentTime()
    {
        ...
        string live_url = "http://13.234.117.221:2556/api/v1/user/lastgame_fatafat";
        ...
        using (UnityWebRequest request = UnityWebRequest.Get(live_url))
        {
            ...
            if (request.result == UnityWebRequest.Result.Success)
            {
                ...
                PattiDataForTime srData = JsonUtility.FromJson<PattiDataForTime>(jsonResponse);
                ...
                if (current_gameId != tempStoredGame_Id)
                {
                    ...
                    if (pattiBetHistoryManager != null)
                    {
                    ...
                    {
                        pattiWinHistoryManager.WinHistoryButtonClick();
                    }
                    else
                    {
                ...
                if ((minutes == 2 && seconds == 0) || (minutes <= 1 && seconds > 0))
                {
                    ...
                    if (pattiSlotMachine != null)
                    {
                        pattiSlotMachine.StartSpinning();
                    }
        ...
        IEnumerator NumberAndVictory()
        {
            ...
            {
                pattiResultManager.GetChosenNumber();
            }
...
[System.Serializable]
public class PattiDataForTime
{
    public bool status;
    public PattiData data;
}