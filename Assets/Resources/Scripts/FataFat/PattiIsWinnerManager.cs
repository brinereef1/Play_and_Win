...
public class PattiIsWinnerManager : MonoBehaviour
{
    ...
    [Header("ApiEndPoint")]
    private string thunderballIsWinner_api_url = "http://13.234.117.221:2556/api/v1/user/iswinner_fatafat";
    ...
    IEnumerator IsWinner()
    {
        ...
        using (UnityWebRequest request = UnityWebRequest.Get(thunderballIsWinner_api_url))
        {
            ...
            PattiIsWinnerRoot isWinner = JsonConvert.DeserializeObject<PattiIsWinnerRoot>(response);
...
[System.Serializable]
public class PattiIsWinnerRoot
{
    public bool success { get; set; }
    public string message { get; set; }
    public PattiIsWinnerData data { get; set; }
}

[System.Serializable]
public class PattiIsWinnerData
{
