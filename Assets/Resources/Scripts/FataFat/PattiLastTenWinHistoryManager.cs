...
using System.Linq;
using System;
public class PattiLastTenWinHistoryManager : MonoBehaviour
{
    ...
    private string api_url = "http://13.234.117.221:2556/api/v1/user/last10fatafatpatti";
    ...
    IEnumerator LastTenWinHistoryRequest()
    {
        ...
        using (UnityWebRequest request = UnityWebRequest.Get(api_url))
        {
            ...
            PattiLastTenWinResponse lastTen_winResponse = JsonConvert.DeserializeObject<PattiLastTenWinResponse>(response);
            if (request.result == UnityWebRequest.Result.Success)
            {
                ...
                foreach (var item in lastTen_winResponse.games)
                {
                    ...
                    var Script = win.transform.GetComponent<PattiLastTenDisplay>();
...
[System.Serializable]
public class PattiLastTenDatum
{
...
[System.Serializable]
public class PattiLastTenWinResponse
{
