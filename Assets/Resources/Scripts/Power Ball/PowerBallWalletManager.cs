...
public class PowerBallWalletManager : MonoBehaviour
{
    ...
    private IEnumerator GetBalanceCoroutine()
    {
        ...
        using (UnityWebRequest request = UnityWebRequest.Get(getBalanceUrl))
        {
            ...
            if (request.result == UnityWebRequest.Result.Success)
            {
                ...
                PowerBallWalletResponse response = JsonConvert.DeserializeObject<PowerBallWalletResponse>(jsonResponse);
...
[System.Serializable]
public class PowerBallWalletResponse
{
