...
public class SpinTheWheelWalletManager : MonoBehaviour
{
    ...
    private IEnumerator GetBalanceCoroutine()
    {
        ...
        using (UnityWebRequest request = UnityWebRequest.Get(getBalanceUrl))
        {
            ...
            if (request.result == UnityWebRequest.Result.Success)
            {
                ...
                SPWWalletResponse response = JsonConvert.DeserializeObject<SPWWalletResponse>(jsonResponse);
...
[System.Serializable]
public class SPWWalletResponse
{
